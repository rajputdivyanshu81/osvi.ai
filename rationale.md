...
## 3. Follow-Up Calls (Existing Claims)
If a caller provides an existing claim number right at the start of the call, the agent intelligently bypasses the Phase 1 safety triage and Phase 2 intake completely. It directly addresses their queries regarding status, premium impact, or settlement timelines, preventing repetitive and frustrating questioning for returning users.

## 4. Neutral Logging & Legal Liability
...
## 5. Operational Realism for Garages
...
## 6. Settlement Timeline Management
